...
const jsxml = require("../index");
const { deepEqual, strictEqual } = chai_1.assert;
function short(s) {
...
function parseTest(xml, js, skipRT) {
    ...
    if (!skipRT)
        strictEqual(jsxml.stringify(jsxml.parse(xml)), xml, 'roundtrip ' + short(xml));
}
    ...
    it('escaping', () => {
        ...
        for (let i = 0; i < 0x10000; i++) {
            ...
            if ((i >= 0x20 && i <= 0x7e) || (i >= 0xa1 && i <= 0xd7ff) || (i >= 0xe000 && i <= 0xfffd)) {
                if (i >= 0x2000 && i < 0xd000)
                    continue; // skip to speed up test
...
//# sourceMappingURL=js-xml-test.js.map